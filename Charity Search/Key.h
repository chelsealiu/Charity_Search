...
#ifndef Charity_Search_Key_h
#define Charity_Search_Key_h

static const NSString* APPLICATION_ID = @"7I0X7QaVxYb9auQqmMsX2UZbdcEYK35Hvqni7sGH";
static const NSString* CLIENT_KEY = @"huk7Cq3hPUZxkHTQYCvYjXZecOtHDUdrHf2dUvHB";
